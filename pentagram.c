...
static void penta_init(void);
static void penta_draw(void);
static void penta_sortie(void);
...
static GLuint _tId[8] = {0};
/*!\brief pour les deux astres : terre et lune */
static GLuint _quad = 0;


void pentagram(int state) {
  switch(state) {
  case GL4DH_INIT:
    penta_init();
    return;
...
void penta_init(void) 
{
  int i;
  SDL_Surface * t;
  int vp[4], w, h;
  static char * files[8] = {
    "./assets/images/pentagram/fond.png",
    "./assets/images/pentagram/pentagram_1.png", 
    "./assets/images/pentagram/pentagram_2.png", 
    "./assets/images/pentagram/pentagram_3.png", 
    "./assets/images/pentagram/pentagram_4.png", 
    "./assets/images/pentagram/pentagram_5.png", 
    "./assets/images/pentagram/pentagram_6.png", 
    "./assets/images/pentagram/pentagram_7.png"
    };
...
void penta_draw(void) 
{
  ...
  gl4duPushMatrix(); {
    ...
    gl4duRotatef(a0, 0, 0, 0);
    gl4duTranslatef(0.04, 0.06, -1.8); //taille de pentagramme
    gl4duScalef(0.7, 0.7, 0.7); //taille fond d'écran
    gl4duSendMatrices();
  } gl4duPopMatrix();
  glUniform1i(glGetUniformLocation(_pId, "specular"), 0);
  gl4dgDraw(_quad);
