...
static void mob_init(void);
static void mob_draw(void);
static void mob_sortie(void);
...
void mob_init(void) 
{
  ...
  SDL_Surface * t;
  int vp[4], w, h;
  static char * files[11] = {
    "./assets/images/mob/fond.png",
    "./assets/images/mob/smoke_1.png", 
    "./assets/images/mob/smoke_2.png", 
    "./assets/images/mob/smoke_3.png", 
    "./assets/images/mob/smoke_4.png", 
    "./assets/images/mob/smoke_5.png",
    "./assets/images/mob/smoke_6.png",
    "./assets/images/mob/mob_1.png",
    "./assets/images/mob/mob_2.png", 
    "./assets/images/mob/mob_3.png", 
    "./assets/images/mob/mob_4.png", 
  };
...
void mob_draw(void) 
{
  ...
  //Mob apear
  glActiveTexture(GL_TEXTURE0);
  glBindTexture(GL_TEXTURE_2D, _tId[((image/9)%8)+2]);
  gl4duPushMatrix(); {
    gl4duScalef(100, 100, 100);
    gl4duRotatef(a0, 0, 0, 0);
    gl4duTranslatef(0.04, 0.06, -1.8); //taille de mob
    gl4duScalef(0.1, 0.1, 0.1); //taille fond d'écran
    gl4duSendMatrices();
  } gl4duPopMatrix();
  glUniform1i(glGetUniformLocation(_pId, "specular"), 0);
  gl4dgDraw(_quad);
...
void mob_sortie(void) 
{
  if (_tId[0]) {
    glDeleteTextures(11, _tId);
    _tId[0] = 0;
  }
  gl4dpDeleteScreen();
}
